          ...
          <Grid templateColumns="auto" gap={6}>
            ...
            <VStack align="stretch">
              <FormControl id="pseudo">
                ...
                <Input type='text' name='pseudo' value={pseudo} onChange={(e) => setPseudo(e.target.value)} size="md" />
              </FormControl>
              ...
              <FormControl id="email">
                ...
                <Input type='text' name='email' value={email} onChange={(e) => setEmail(e.target.value)} size="md" />
              </FormControl>
              <FormControl id="password">
                <FormLabel>Mot de Passe:</FormLabel>
                <Input type='password' name='password' value={password} onChange={(e) => setPassword(e.target.value)} size="md" />
              </FormControl>
              <FormControl id="confirmPassword">
                <FormLabel>Confirmation du Mot de Passe:</FormLabel>
                <Input type='password' name='password' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} size="md" />
              </FormControl>
              <FormControl id="campus">
                <FormLabel>Campus :</FormLabel>
                <Select onSelect={(e)=>setCampus(e.target.value)} placeholder='Sélectionne une option'>
